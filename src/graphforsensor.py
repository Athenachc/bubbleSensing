...
with open('Sensor/sensor.txt', 'r') as file:
    for line in file:
        ...
        magnitude.append(float(parts[1].strip()))
        vectors_x.append(float(parts[2].strip()))
        vectors_y.append(float(parts[3].strip()))
...
new_magnitude_plus = [i * 0.014 for i in new_magnitude]
vector_mean_x_plus = [i * shear_coefficient for i in vector_mean_x]
